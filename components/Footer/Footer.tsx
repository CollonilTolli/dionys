      ...
      <div className={classes.Footer}>
        ...
        <div className="container">
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <stop offset="0.927" stopColor="#FA2D32"></stop>
                        </linearGradient>
                      </defs>
                    </svg>
                    <Link
                ...
                {data.contacts.contacts.telegram && (
                  <div className={classes.contacts_contacts_item}>
                    ...
                    <Link
                      ...
                      className={classes.contact}
                    >
                      @{data.contacts.contacts.telegram.name}
                    </Link>
                  </div>
                )}
                {data.contacts.contacts.location && (
                  <div className={classes.contacts_contacts_item}>
                    ...
                    <div className={classes.contact}>
                      {data.contacts.contacts.location.text}
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className={classes.services}>
              ...
              <div className={classes.services_items}>
                {data.services.services.map((el) => (
                  <div className={classes.services_items_item} key={el.link}>
          ...
          <div className={classes.Footer_bottom}>
            <Link href={data.policy.link} className={classes.policy}>
              {data.policy.text}
            </Link>
            {data.warning && <p className={classes.warning}>{data.warning}</p>}
            <a
              className={classes.ColStudio}
              href="https://col-studio.com/"
              title="Разработано ColStudio"
            >
              <Image
                src="https://col-studio.com/static/ColStudioLogoDark.svg"
                alt=""
                width={190}
                height={77}
              />
              <span>Разработано командой ColStudio</span>
            </a>
          </div>
        </div>
      </div>
